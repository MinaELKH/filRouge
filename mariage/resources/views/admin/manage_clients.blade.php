...
@section('content')
    <div class="container mx-auto p-4">
        <h2 class="text-3xl font-bold mb-6 text-gray-800">Gestion des Clients</h2>

        <!-- Barre de recherche -->
        <form method="GET" action="{{ route('admin.manage_clients') }}" class="mb-6 flex flex-wrap gap-4 items-center">
        ...
        <div class="overflow-x-auto bg-white shadow-md rounded-lg">
            <table class="min-w-full divide-y divide-gray-200 text-sm text-gray-700">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center px-6 py-4 text-gray-500">Aucun client trouvé.</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
