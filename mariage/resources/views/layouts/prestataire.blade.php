...
@section('content')
    <div class="max-w-6xl mx-auto mt-8 p-6 bg-white shadow-lg rounded-xl border border-pink-100">
        <h1 class="text-3xl font-bold mb-8 text-pink-800 border-b pb-4 border-pink-200">Mes Devis Envoyés</h1>
            ...
            <table class="min-w-full table-auto">
                ...
                @forelse($devisList as $devis)
                    <tr class="hover:bg-pink-50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ $devis->total_amount }} €</td>
