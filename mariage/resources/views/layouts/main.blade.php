...
<body class="{{ (Auth::user() && Auth::user()->role == 'prestataire') ? 'bg-gray-50' : 'bg-gray-100' }} flex flex-col min-h-screen">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <aside class="bg-white p-4 rounded shadow">
                <ul class="space-y-2 text-sm">
                    <li><a href="{{ route('client.dashboard') }}" class="{{ request()->routeIs('client.dashboard') ? 'text-wedding-pink font-medium' : 'text-gray-600 hover:text-wedding-pink' }}">Mon espace</a></li>
                    <li><a href="{{ route('client.profile') }}" class="{{ request()->routeIs('client.profile') ? 'text-wedding-pink font-medium' : 'text-gray-600 hover:text-wedding-pink' }}">Mes informations</a></li>
                    <li><a href="{{ route('client.tasks') }}" class="{{ request()->routeIs('client.tasks') ? 'text-wedding-pink font-medium' : 'text-gray-600 hover:text-wedding-pink' }}">Tâches</a></li>
                    <li><a href="{{ route('client.favorites') }}" class="{{ request()->routeIs('client.favorites') ? 'text-wedding-pink font-medium' : 'text-gray-600 hover:text-wedding-pink' }}">Favoris</a></li>
                    <li><a href="{{ route('client.devis') }}" class="{{ request()->routeIs('client.devis') ? 'text-wedding-pink font-medium' : 'text-gray-600 hover:text-wedding-pink' }}">Devis</a></li>
                    <li><a href="{{ route('client.reservations') }}" class="{{ request()->routeIs('client.reservations') ? 'text-wedding-pink font-medium' : 'text-gray-600 hover:text-wedding-pink' }}">Services réservés</a></li>
                </ul>
            </aside>
